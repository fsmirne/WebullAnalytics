...
public static class ExcelExporter
{
	public static void ExportToExcel(List<ReportRow> reportRows, List<PositionRow> positionRows, List<Trade> allTrades, decimal finalPnL, decimal initialAmount, string outputPath, decimal? ivLong = null, decimal? ivShort = null, IReadOnlyDictionary<string, OptionContractQuote>? optionQuotesBySymbol = null, IReadOnlyDictionary<string, decimal>? underlyingPrices = null, IReadOnlyDictionary<string, decimal>? underlyingPriceOverrides = null, bool theoretical = false, IReadOnlyDictionary<string, List<decimal>>? extraNotablePrices = null)
	{
		...
		ExportBreakEven(breakEvenSheet, positionRows, ivLong, ivShort, optionQuotesBySymbol, underlyingPrices, underlyingPriceOverrides, theoretical, extraNotablePrices);
	...
	{
		var results = BreakEvenAnalyzer.Analyze(positionRows, ivLong, ivShort, optionQuotesBySymbol: optionQuotesBySymbol, underlyingPrices: underlyingPrices, underlyingPriceOverrides: underlyingPriceOverrides, theoretical: theoretical, extraNotablePrices: extraNotablePrices);
		if (results.Count == 0)
		{
