...
public static class PositionTracker
{
    ...
    /// </summary>
    private static ReportRow? BuildReportRow(Trade trade, decimal realized, decimal closedQty, decimal fee, ref decimal running, ref decimal cash, decimal initialAmount)
    {
