...
# Publish the daily data-refresh script + its Python helpers alongside the wa executable so the
# scheduled refresh runs self-contained from the install location (not the repo checkout).
